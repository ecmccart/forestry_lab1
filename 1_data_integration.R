...
#----------------
u2_data <- read.csv('https://raw.githubusercontent.com/ecmccart/forestry_lab1/refs/heads/main/U2_2017data.csv?token=GHSAT0AAAAAADAORX77U2G7234S5UDJ3VESZ7PJ4RA')
str(u2_data)
#----------------
...
#----------------
u2_data <- clean_overstory <- clean_data %>%
  filter(Class == "O")
#----------------
...
#----------------     
SppCode <- read.csv('https://raw.githubusercontent.com/ecmccart/forestry_lab1/refs/heads/main/Species_Codes.csv?token=GHSAT0AAAAAADAORX76ANB3YJYWTHDEAYJYZ7PJ5NA')
#---------------- 
